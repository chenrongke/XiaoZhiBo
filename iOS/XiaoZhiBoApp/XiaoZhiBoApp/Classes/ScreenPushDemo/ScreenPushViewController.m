...
//                controller.qrString = accPlayUrl;
                hub.labelText = @"获取地址成功";
                hub.detailsLabelText = @"播放地址已复制到剪贴板";
                [hub show:YES];
                [hub hide:YES afterDelay:2];
            });
        }
...
//                [defaults synchronize];
                ...
                NSString *pushUrl = [defaults objectForKey:kReplayKit2PushUrlKey];
                NSMutableDictionary* dict = [NSMutableDictionary new];
                if (pushUrl) {
                    [dict setObject:pushUrl forKey:kReplayKit2PushUrlKey];
                }
